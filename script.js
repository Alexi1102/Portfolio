...
(function () {
  ...
  function fitHeroName() {
    ...
    // Pointillés et curseur : taille propre (clamp() en vw/rem), pas
    ...
    // — .hero__rey-row a overflow-x:hidden (garde-fou), donc tout
    // débordement horizontal serait invisible, pas juste visuellement coupé.
    ...
    // les pointillés/curseur) : UI/UX DESIGNER doit toujours faire la même
    // taille que ce texte, pas s'ajuster à la largeur totale du groupe (qui
    // inclut les pointillés/curseur).
